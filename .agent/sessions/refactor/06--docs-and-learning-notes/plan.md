...
- Date: `2026-03-10`
- Owner: `Codex`
- Current Cycle: `02-learning-content-reframe`
- Plan Snapshot: `plans/02-learning-content-reframe.md`
...
- Planned documentation additions:
  ...
  - the learning note explicitly separates technical usage learning from process/skill-design learning.
...
- Add:
  ...
  - a learning note that captures branch history, key architecture decisions, next-session re-entry context, and explicit learning takeaways.
  - wording that frames the Server Action boundary work as skill/rule-design practice rather than as a standalone architecture topic learned in isolation.
...
## Documentation Rules For Cycle 2
...
5. Learning notes must distinguish:
   - TDD/testing learning
   - Supabase usage and operational validation learning
   - skill/rule design practice, including how architectural intent was encoded into skills and docs
6. If documentation review exposes a real code/doc mismatch, stop and replan before mixing a code fix into the docs branch.
...
- Done criteria:
  ...
  - the note separates:
    - TDD as testing practice and test design learning
    - Supabase usage learning, including migrations, RLS, and operational validation
    - skill/rule design practice, including the attempt to steer implementation through architecture skills and scaffold rules
  - the Server Action boundary topic is framed as part of the skill-design and guided-implementation exercise, not overstated as an isolated learning theme.
...
- RED:
  - the repo currently promises learning notes in the PRD and master plan, but no canonical learning note exists and the first baseline did not yet reflect the user's clarified learning categories.
- GREEN:
  - add a concise learning/re-entry note that summarizes what was built, why the current structure exists, what was learned technically, and what was learned about guiding implementation with skills and rules.
- REFACTOR:
...
- Verify:
  ...
  - `rg -n "TDD|test|Supabase|RLS|skill|rule|Server Action|re-entry" docs/LEARNING-NOTES.md`
- Failure recovery:
