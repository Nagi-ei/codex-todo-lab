...
- AI pointer: `/Users/nagi/Downloads/codex-test/.ai/PRD.md`
...
1. `feature/01--bootstrap-next-shadcn`
2. `feature/02--supabase-auth`
3. `feature/03--todo-server-actions`
4. `fix/04--tests-and-stability`
